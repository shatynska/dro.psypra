  ...
  return (
    <>
      ...
      <section className="relative text-background lg:h-[44rem]">
        <div className="grid grid-cols-[1fr_9.5rem_4.75rem_1rem_1fr] grid-rows-[6rem_7.75rem_2.75rem_2.75rem_5rem_16rem] content-center justify-center pt-4 sm:grid-cols-[1fr_14.25rem_7.25rem_1.75rem_1fr] sm:grid-rows-[6rem_11.75rem_4.25rem_4rem_5rem_16rem] lg:h-screen lg:max-h-192 lg:min-h-160 lg:grid-cols-[0_14.25rem_7.25rem__minmax(8rem,24rem)_16rem] lg:grid-rows-[8rem_11.75rem_4.25rem] lg:pt-16">
